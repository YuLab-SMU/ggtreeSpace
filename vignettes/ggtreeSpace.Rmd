...
achieve the most basic effects. And most importantly, previously, users could 
not add phylomorphospace as a graphical layer directly through `ggtree`, 
which was not only inconvenient but also limited its usage in more complex 
analyses.
